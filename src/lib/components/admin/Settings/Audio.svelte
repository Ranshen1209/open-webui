			...
			<div>
					...
					<div>
						<div class="flex items-center justify-between mb-2">
							...
							<label class="relative inline-flex items-center cursor-pointer">
								...
								/>
								<div
									class="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-primary-600"
								></div>
							</label>
						</div>
				...
				{:else if STT_ENGINE === ''}
					<div>
						...
						<div class="mt-2 mb-1 text-xs text-gray-400 dark:text-gray-500">
							{$i18n.t(`Sakrylle Web uses faster-whisper internally.`)}
				...
				<div class="mb-2">
					...
					{:else if TTS_ENGINE === 'transformers'}
						<div>
							...
							<div class="mt-2 mb-1 text-xs text-gray-400 dark:text-gray-500">
								{$i18n.t(`Sakrylle Web uses SpeechT5 and CMU Arctic speaker embeddings.`)}
