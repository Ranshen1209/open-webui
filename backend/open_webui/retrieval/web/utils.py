...
# resolve_hostname / validate_url / safe_validate_urls were extracted to the
# lightweight open_webui.utils.url module so always-on callers (oauth, images,
# files, webhook) can validate URLs without importing this module's heavy
# web-loader chain. Re-exported here for retrieval-side callers.
from open_webui.utils.url import (  # noqa: E402
    resolve_hostname,
    safe_validate_urls,
    validate_url,
)
