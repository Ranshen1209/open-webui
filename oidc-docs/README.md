...
# Sakrylle Web OIDC Notes

This directory contains only product-local implementation notes for **Sakrylle Web**.
...
Do not duplicate OIDC protocol details, platform claims rules, roadmap, risk register, or design system content here. Update the center docs instead.
